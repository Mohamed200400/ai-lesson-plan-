      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 overflow-y-auto">
        <div className="w-full max-w-md py-8">
          ...
          <form className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" placeholder="محمد أحمد" className="w-full pr-11 pl-4 py-3 rounded-xl border border-slate-200 bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" placeholder="name@example.com" className="w-full pr-11 pl-4 py-3 rounded-xl border border-slate-200 bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPassword ? "text" : "password"} placeholder="••••••••" className="w-full pr-11 pl-11 py-3 rounded-xl border border-slate-200 bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition" />
            ...
            <div>
              ...
              <div className="relative">
                <Lock className="absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400" />
                <input type={showConfirm ? "text" : "password"} placeholder="••••••••" className="w-full pr-11 pl-11 py-3 rounded-xl border border-slate-200 bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition" />
          ...
          <div className="my-6 flex items-center gap-3">
            ...
            <span className="text-xs text-slate-500">أو سجّل باستخدام</span>
            <div className="flex-1 h-px bg-slate-200" />
          </div>
